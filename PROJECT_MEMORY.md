...
กับตัวเลขที่ชุมชนกรอกมือ — ยึด "07:00→07:00" ต่อไปได้ ไม่ต้องเปลี่ยนสูตร

**✅ ยืนยันสาเหตุแล้ว 2026-07-18 (รอบ 2)**: ผู้ใช้ยืนยันว่าความคลาดเคลื่อนวันที่ 14 ก.ค. เกิดจาก
**ความผิดพลาดตอนกรอกข้อมูลด้วยมือ** (ไม่ใช่เซนเซอร์คนละตัว ไม่ใช่บั๊ก window/timing ของโค้ด) —
**ปิดประเด็นนี้แล้ว ไม่ใช่ความเสี่ยงเชิงระบบที่ต้องแก้โค้ดเพิ่ม** สูตร/pipeline ปัจจุบันถูกต้องแล้ว
ความเสี่ยงที่เหลือคือคุณภาพของการกรอกมือในอดีตเท่านั้น ไม่กระทบระบบอัตโนมัติที่ไป live แล้ว (เพราะ
เลิกพึ่งการกรอกมือสำหรับข้อมูลระดับน้ำ/ฝนไปแล้ว ตั้งแต่เปลี่ยนมาใช้ telemetry สด)
...
| RES006 | อ่างเก็บน้ำห้วยโซ้ (Huai So) | 508.10 | 0.122 ล้าน ลบ.ม. |
...
4. ยืนยัน rain-window convention (07:00→07:00) ด้วยข้อมูลขนานเพิ่มเติม — **ยืนยันแล้ว 2026-07-18**
   ผู้ใช้ยืนยันสาเหตุความคลาดเคลื่อนวันที่ 14 ก.ค. คือกรอกมือผิดพลาด ไม่ใช่บั๊ก window/timing — ปิดประเด็น
