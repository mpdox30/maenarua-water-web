...
**อัปเดต 2026-07-18**: ผู้ใช้ยืนยันให้ตัดจาก shadow mode ไป live ทันที ตอนนั้นยังไม่ชัดเจนว่า
ความคลาดเคลื่อนที่เคยเจอสูงสุด ~2,169 m3 (วันที่ 14 ก.ค.) มาจาก rain-window convention
(07:00→07:00) หรือแหล่งอื่น (ดู reservoir_telemetry_from_sheet.py หัวข้อ "สิ่งสำคัญที่ต้องรู้" ข้อ 2)
**อัปเดต 2026-07-18 (รอบ 2) — ปิดประเด็นแล้ว**: ทดสอบสลับ window 7 รูปแบบพบว่าไม่ใช่สาเหตุ และ
ผู้ใช้ยืนยันแล้วว่าความคลาดเคลื่อนนั้นเกิดจากกรอกข้อมูลด้วยมือผิดพลาด (ไม่ใช่บั๊ก timing/window ของ
โค้ด) — สูตร 07:00→07:00 ถูกต้องแล้ว ไม่ต้องแก้ ความเสี่ยงนี้ไม่กระทบระบบอัตโนมัติปัจจุบันเพราะเลิก
พึ่งการกรอกมือสำหรับระดับน้ำ/ฝนไปแล้ว
