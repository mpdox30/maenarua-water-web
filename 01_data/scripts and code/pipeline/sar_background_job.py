...
ไม่ต้องรันพร้อมกับ pipeline หลักทุกรอบ — เป็น pattern โมดูลแยกที่ตั้งใจให้รันซ้ำๆ ผ่าน scheduler ของ
ตัวเอง เขียนผลสะสม/ล่าสุดไว้ที่ไฟล์ ให้ตัวอื่นมาอ่านทีหลัง
